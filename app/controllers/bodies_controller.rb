class BodiesController < ApplicationController
  ...
  private
    ...
    def body_params
      params.require(:body).permit(:full_name, :weight, :stature, :head_circumference, :shoulder_breadth, :hand_length, :hand_breadth, :chest_circumference, :waist_circumference, :foot_length, :foot_breadth, :age, :gender)
    end
end
